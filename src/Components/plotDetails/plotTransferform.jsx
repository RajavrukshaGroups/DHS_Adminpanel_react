          ...
          <div className="grid gap-6 md:grid-cols-3">
            <div className="space-y-2">
              ...
              <input
                ...
                value={toMember.name}
                onChange={(e) =>
                  setToMember({ ...toMember, name: e.target.value })
                }
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <input
                  ...
                  onChange={(e) =>
                    setToMember({ ...toMember, transferDate: e.target.value })
                  }
                />
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                onChange={(e) =>
                  setToMember({ ...toMember, mobileNumber: e.target.value })
                }
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                onChange={(e) =>
                  setToMember({ ...toMember, email: e.target.value })
                }
              />
            </div>
            ...
            <div className="space-y-2 md:col-span-2">
              ...
              <textarea
                ...
                onChange={(e) =>
                  setToMember({ ...toMember, address: e.target.value })
                }
              />
            </div>
            ...
            <div className="space-y-2 md:col-span-3">
              ...
              <textarea
                ...
                onChange={(e) =>
                  setToMember({ ...toMember, reason: e.target.value })
                }
              />
            </div>
          </div>
