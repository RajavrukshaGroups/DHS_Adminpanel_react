    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-blue-100 flex flex-col">
      ...
      <div className="flex-1 flex  justify-center p-4">
        <div className="w-full max-w-md pt-16">
          ...
          <div className="bg-[#faf5f0] rounded-lg shadow-lg p-8">
            ...
            className="space-y-6">
              <div className="space-y-2">
                <label htmlFor="email" className="block text-start font-medium text-gray-900">
                  Email Id
                </label>
                <input
                  id="email"
              ...
              <div className="space-y-2">
                <label htmlFor="password" className="block text-start font-medium text-gray-900">
                  Password
                </label>
                <input
                  id="password"
         ...
         disabled={loading}
         className={`${
           loading ? 'bg-blue-600 cursor-not-allowed' : 'bg-blue-400 hover:bg-blue-500'
